...
//            if (nb % 1000 == 0) {
//                if ((SInt16)gainSample > 0)
//                {
////                    NSLog(@"gainSample = %d", (SInt16)gainSample);
//                    if ([self.delegate respondsToSelector:@selector(audioBuffer:)]) {
//                        [self.delegate audioBuffer:(SInt16)gainSample];
//                    }
//                    
//                }
//            }
...
//    NSLog(@"buffer = %f", ((double)editBuffer[0]));

    if ((SInt16)editBuffer[0] > 0)
    {
//      NSLog(@"gainSample = %d", (SInt16)editBuffer[0]);
        if ([self.delegate respondsToSelector:@selector(audioBuffer:)]) {
            [self.delegate audioBuffer:(SInt16)editBuffer[0]];
        }
    }
